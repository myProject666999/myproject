...
@Component
public class DouyinDataNormalizer implements PlatformDataNormalizer {

    @Override
    public PlatformCodeEnum getPlatformCode() {
        return PlatformCodeEnum.DOUYIN;
    }
    ...
    public UnifiedMetricsDTO normalizeAccountData(PlatformAccountDataDTO rawData) {
        ...
        unified.setPlatformCode(PlatformCodeEnum.DOUYIN.getCode());
