...
@Component
public class XiaohongshuDataNormalizer implements PlatformDataNormalizer {

    @Override
    public PlatformCodeEnum getPlatformCode() {
        return PlatformCodeEnum.XIAOHONGSHU;
    }
    ...
    public UnifiedMetricsDTO normalizeAccountData(PlatformAccountDataDTO rawData) {
        ...
        unified.setPlatformCode(PlatformCodeEnum.XIAOHONGSHU.getCode());
