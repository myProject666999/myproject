-- 重置数据库脚本
-- 使用方法：mysql -u root -p < database/reset.sql

DROP DATABASE IF EXISTS comics_platform;
CREATE DATABASE comics_platform DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE comics_platform;
