...
-- 插入测试数据（使用INSERT IGNORE避免重复）
INSERT IGNORE INTO `user` (`id`, `username`, `nickname`, `avatar`, `birthday`, `password`) VALUES
(1, 'alice', '爱丽丝', NULL, '1995-06-15', '123456'),
(2, 'bob', '鲍勃', NULL, '1994-08-20', '123456'),
(3, 'charlie', '查理', NULL, '1996-03-10', '123456');

INSERT IGNORE INTO `friendship` (`id`, `user_id`, `friend_id`, `status`) VALUES
(1, 1, 2, 1),
(2, 2, 1, 1),
(3, 1, 3, 1),
(4, 3, 1, 1);

INSERT IGNORE INTO `wishlist` (`id`, `user_id`, `title`, `description`, `is_public`) VALUES
(1, 1, '生日礼物', '希望收到的生日礼物', 1),
(2, 1, '圣诞礼物', '圣诞心愿清单', 1),
(3, 2, '生日愿望', '今年的生日愿望', 1);

INSERT IGNORE INTO `item` (`id`, `wishlist_id`, `title`, `description`, `url`, `image_url`, `price`, `priority`, `is_claimed`) VALUES
(1, 1, 'AirPods Pro', '降噪耳机', 'https://www.apple.com/airpods-pro/', NULL, 1999.00, 2, 1),
(2, 1, '机械键盘', 'Cherry轴机械键盘', 'https://www.cherrymx.de/', NULL, 899.00, 1, 0),
(3, 2, '旅行背包', '大容量旅行背包', NULL, NULL, 599.00, 2, 0),
(4, 3, '游戏手柄', 'PS5游戏手柄', NULL, NULL, 499.00, 1, 0);

INSERT IGNORE INTO `claim_record` (`id`, `item_id`, `user_id`, `owner_id`, `message`, `is_purchased`) VALUES
(1, 1, 2, 1, '我帮你买这个！', 0);
