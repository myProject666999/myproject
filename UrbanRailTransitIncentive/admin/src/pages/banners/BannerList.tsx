...
import { Table, Button, Input, Space, Modal, Form, Select, message, Popconfirm, InputNumber, Image } from 'antd'
...
const BannerList = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: 'image_url',
      render: (url: string) => (
        url ? <Image width={80} height={40} src={url} style={{ objectFit: 'cover', borderRadius: 4 }} /> : '-'
      )
    },
    {
      title: '链接',
