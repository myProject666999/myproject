INSERT IGNORE INTO exchange_rates (currency_from, currency_to, rate) VALUES
('CNY', 'CNY', 1.000000),
('USD', 'CNY', 7.250000),
('EUR', 'CNY', 7.850000),
('GBP', 'CNY', 9.200000),
...
INSERT IGNORE INTO subscriptions (name, description, category, price, currency, cycle_type, cycle_days, start_date, next_renewal_date, is_active, reminder_days, payment_method, account) VALUES
